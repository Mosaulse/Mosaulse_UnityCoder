...
UnityCoder是一个专门为Unity 2021.3及以上版本设计的代码编辑器集成包，支持Visual Studio Code及其流行的变体编辑器（包括Cursor、Antigravity、Trae、Trae CN、Kiro、Qoder、Lingma、Windsurf等），同时排除了Visual Studio的自动发现功能。
...
5. 输入包的Git地址: `https://gitcode.com/Mosaulse/UnityCoder.git`
6. 点击 `Add` 按钮
